...
export const Network = () => {
    ...
    return (_jsxs("div", { className: "rpc", children: [_jsx("span", { children: "Connected to" }), _jsx(NetworkSelect, {}), _jsx("span", { children: "with" }), _jsx(Select, { className: "select--small select--mono select--align-start", options: rpcs
