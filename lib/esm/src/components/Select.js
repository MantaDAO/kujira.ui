...
export function Select({ options, selected, onChange, dark = false, className, allowCustomInput, onCustomChange, disabled, suffix, placeholder, }) {
    ...
    return (_jsxs("div", Object.assign({ ref: node, className: clsx({
            ...
            [`${className}`]: className,
                ...
                } })) : selected || internalSelection ? (_jsx(_Fragment, { children: selected ? (_jsxs(_Fragment, { children: [selected.status && _jsx("b", { className: selected.status }), selected.label] })) : (_jsx(_Fragment, { children: internalSelection && internalSelection.label })) })) : (_jsx("span", Object.assign({ className: "color-grey" }, { children: placeholder }))), !disabled && (_jsxs(_Fragment, { children: [_jsx("div", { className: "select__space" }), _jsx(IconArrow, {})] })), open && (_jsx("ul", Object.assign({ ref: drop }, { children: options.map((m, i) => (_jsxs("li", Object.assign({ onClick: () => handleChange(m.value), className: (selected && m.value === selected.value) ||
                        (internalSelection &&
