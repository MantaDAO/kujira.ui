...
export default function Input(_a) {
    ...
    return (_jsxs("div", { className: clsx({
            ...
            [`${className}`]: className,
        }), children: [label && _jsx("label", { htmlFor: id, children: label }), !readOnly ? (_jsx("input", Object.assign({ id: id, value: value, onChange: onChange, readOnly: !onChange, step: step || 1, onFocus: () => setFocus(true), onBlur: () => setFocus(false) }, rest))) : (_jsx("span", { children: value })), icon && _jsx("button", { onClick: onSubmit, children: icon }), children] }));
}
