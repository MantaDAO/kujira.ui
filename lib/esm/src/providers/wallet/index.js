...
export const WalletContext = ({ children, }) => {
    ...
    return (_jsxs(Context.Provider, Object.assign({ value: {
            ...
            setFeeDenom,
            chainInfo,
        } }, { children: [children, _jsx(Modal, Object.assign({ show: modal, close: () => {
                    setStored("");
                    setModal(false);
                }, className: "modal--auto" }, { children: _jsxs("div", Object.assign({ className: "md-flex ai-c" }, { children: [_jsx("div", Object.assign({ className: "no-shrink bg-darkGrey" }, { children: _jsx(QR, Object.assign({ height: 256, color: "#ffffff", backgroundColor: "transparent", rounding: 150, cutout: true, cutoutElement: _jsx("img", { src: Logo, style: {
                                        objectFit: "contain",
                                        width: "100%",
                                        height: "100%",
                                    } }), errorCorrectionLevel: "M" }, { children: link })) })), _jsxs("div", Object.assign({ className: "ml-3" }, { children: [_jsx(IconSonar, { style: {
                                        display: "block",
                                        height: "3rem",
                                        marginBottom: "1.5rem",
                                    } }), _jsx("h3", { children: "Scan this code using the Sonar Mobile App." }), _jsxs("a", Object.assign({ href: appLink("sonar"), target: "_blank", className: "md-button mt-2 md-button--icon-right" }, { children: ["Download Sonar", _jsx(IconAngleRight, {})] }))] }))] })) })), _jsx(Modal, Object.assign({ show: showAddress, close: () => setShowAddress(false), confirm: () => ReadOnly.connect(address).then((w) => {
                    setStored(Adapter.ReadOnly);
                    setWallet(w);
                    setShowAddress(false);
                }), title: "Read Only Connection" }, { children: _jsxs(_Fragment, { children: [_jsxs("p", Object.assign({ className: "fs-14 lh-16 color-white mb-2" }, { children: ["Enter a Kujira address to see a ", _jsx("strong", { children: "read only" }), " ", "version of the app, as if connected with this address."] })), _jsx(Input, { placeholder: "kujira1...", value: address, onChange: (e) => setAddress(e.currentTarget.value) })] }) })), _jsx(Modal, Object.assign({ show: showCW3, close: () => setShowCW3(false), confirm: () => wallet &&
                    (wallet instanceof Sonar || wallet instanceof Keplr) &&
                    CW3Wallet.connect(address, wallet).then((w) => {
                        setStored(Adapter.CW3);
                        setWallet(w);
                        setShowCW3(false);
                    }), title: "SQUAD Connection" }, { children: _jsxs(_Fragment, { children: [_jsx("p", Object.assign({ className: "fs-14 lh-16 color-white mb-2" }, { children: "Enter a SQUAD address. You will be able to submit proposals to the SQUAD where normally you would execute those transactions with your own account." })), _jsx(Input, { placeholder: "kujira1...", value: address, onChange: (e) => setAddress(e.currentTarget.value) })] }) }))] }), network + (wallet === null || wallet === void 0 ? void 0 : wallet.account.address)));
};
