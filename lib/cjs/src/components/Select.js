...
function Select({ options, selected, onChange, dark = false, className, allowCustomInput, onCustomChange, disabled, suffix, placeholder, }) {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", Object.assign({ ref: node, className: (0, clsx_1.default)({
            ...
            [`${className}`]: className,
                ...
                } })) : selected || internalSelection ? ((0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: selected ? ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [selected.status && (0, jsx_runtime_1.jsx)("b", { className: selected.status }), selected.label] })) : ((0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: internalSelection && internalSelection.label })) })) : ((0, jsx_runtime_1.jsx)("span", Object.assign({ className: "color-grey" }, { children: placeholder }))), !disabled && ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)("div", { className: "select__space" }), (0, jsx_runtime_1.jsx)(IconArrow_1.IconArrow, {})] })), open && ((0, jsx_runtime_1.jsx)("ul", Object.assign({ ref: drop }, { children: options.map((m, i) => ((0, jsx_runtime_1.jsxs)("li", Object.assign({ onClick: () => handleChange(m.value), className: (selected && m.value === selected.value) ||
                        (internalSelection &&
                            internalSelection.value === m.value)
                        ? "current"
                        : "" }, { children: [m.status && (0, jsx_runtime_1.jsx)("b", { className: m.status }), (0, jsx_runtime_1.jsx)("span", { children: m.label }), suffix && suffix(m)] }), m.label))) })))] })));
}
