...
const ar_AE_json_1 = __importDefault(require("../../i18n/translations/ar-AE.json"));
const de_DE_json_1 = __importDefault(require("../../i18n/translations/de-DE.json"));
const es_ES_json_1 = __importDefault(require("../../i18n/translations/es-ES.json"));
const it_IT_json_1 = __importDefault(require("../../i18n/translations/it-IT.json"));
const ru_RU_json_1 = __importDefault(require("../../i18n/translations/ru-RU.json"));
const template_json_1 = __importDefault(require("../../i18n/translations/template.json"));
const tr_TR_json_1 = __importDefault(require("../../i18n/translations/tr-TR.json"));
